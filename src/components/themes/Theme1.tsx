...
import {
  countGuestComment,
  countRSPVStatus,
  getAllGuestCommentsByWeddingSessionId,
} from "@/src/app/[lang]/api/api";
...
const Theme1 = ({ lang }: { lang: Locale }) => {
  ...
  const [countGuestComments, setCountGuestComments] =
    useState<CountGuestComments | null>(null);

  const [ucapanUndanganDigital, setUcapanUndanganDigital] =
    useState<UcapanUndanganDigital | null>(null);
  ...
  const [dayPart, monthPart, yearPart] =
    wedding.reception_begin_at.date.split("-");
  ...
  const dataUcapanUndanganDigital = async () => {
    ...
    try {
      ...
      console.log(
        response.data.data.wedding.undangan_digital.ucapan_undangan_digital
      );
      setUcapanUndanganDigital(
        response.data.data.wedding.undangan_digital.ucapan_undangan_digital
      );
    } catch (error) {
      console.error(error);
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    if (message.trim() === "") {
      ...
      try {
        ...
        const postUcapanUndanganDigital = await axios.post(
          `https://panel.virtuwed.id/api/guest/ucapan/undangan`,
          {
  ...
  return (
    <main className="relative overflow-hidden">
      {/* OPENING */}
      <div
        ref={openingContainerDigitalInvitation}
        className="absolute z-50 w-full h-full top-0 left-0"
      >
        <main
          className={`relative container min-w-full mx-auto min-h-[100dvh] h-[100dvh] text-center max-w-screen-xl`}
        >
          <Image
            src={
          ...
          <div className="grid gap-6 justify-items-center items-center tall:content-center min-h-[100dvh] h-[100dvh] px-4 bg-white z-40">
            <div className="grid justify-center gap-2 z-10">
              <h2
                ...
                className={`${playFair.className} italic`}
              >
                Selamat datang bapak/ibu/saudara/i{" "}
              </h2>
              <h3
                data-aos="zoom-in"
                data-aos-delay="500"
                data-aos-duration="500"
                className={`${playFair.className} text-xl md:text-3xl`}
              >
                {guest.nama}
              </h3>
            </div>
            ...
            <div className="grid gap-2 z-10">
              <h2
                ...
                data-aos-delay="1000"
                data-aos-duration="500"
                className={`${playFair.className} text-lg italic`}
              >
                Di acara pernikahan dari
              </h2>
              <h1
                data-aos="zoom-in"
                data-aos-duration="1000"
                className={`${playFair.className} text-5xl text-secondary`}
              >
            ...
            <div className="grid gap-4 max-w-screen-md w-full mx-auto z-10">
              <button
                onClick={openDigitalInvitation}
                className={`${playFair.className} px-1.5 py-3 bg-secondary text-white rounded-lg flex items-center justify-center w-full gap-2`}
              >
              ...
              <div className="flex w-full gap-4">
                <Link
                  href={`/${lang}/${wedding.wedding_slug}/${guest.guest_slug}/resepsivirtual`}
      ...
      <div
        className={`overflow-hidden min-h-screen lg:grid lg:grid-cols-12 lg:relative`}
      >
        <section className="hidden lg:grid col-span-8 h-screen w-4/6 bg-secondary fixed p-5">
          {wedding.undangan_digital.cover_undangan_digital && (
            <div className={`relative w-full h-full grid items-end p-16`}>
              ...
              />
              <h1
                className={`${playFair.className} uppercase z-50 text-secondary text-6xl`}
              >
                {wedding.wedding_name}
              </h1>
            </div>
        ...
        <section className="block lg:grid lg:col-span-4 lg:col-start-9 relative">
          {/* NAVIGATION */}
          <section className="fixed bottom-0 left-0 h-auto lg:w-2/6 lg:right-0 lg:left-auto bg-white text-secondary w-full py-3 grid grid-cols-2 justify-items-center z-30 border-t border-secondary">
            <Link
              href={`/${lang}/${wedding.wedding_slug}/${guest.guest_slug}/resepsivirtual`}
          ...
          <section className="container grid min-w-full justify-center h-screen px-2.5 py-5 bg-rsvp-texture bg-cover bg-no-repeat bg-center">
            <div
              data-aos="zoom-in"
              data-aos-duration="1000"
              className="grid h-full justify-end max-w-md rounded-full bg-white bg-opacity-75 border-2 border-solid border-tertiaryInv"
            >
              <div className="grid text-center items-center w-full px-5">
                ...
                <p
                  ...
                  data-aos-delay="800"
                  className={`${playFair.className} mb-4 italic`}
                >
                  Wedding Invitation
                </p>
                <h1
                  ...
                  data-aos-delay="500"
                  className={`${playFair.className} text-tertiaryInv text-6xl uppercase font-thin`}
                >
                  {wedding.wedding_name.replace("&", "")}
                </h1>
                <p
                  data-aos="fade-up"
                  data-aos-duration="1200"
                  data-aos-delay="800"
                  className={`${playFair.className} mt-4 text-base italic`}
                >
                  Two souls become one heart
                </p>
          ...
          <div className="relative py-14">
            <div className="relative text-center mx-4 py-5">
              <div
                ...
                className="absolute bottom-0 top-0 mx-auto right-0 left-0 w-full max-w-sm bg-no-repeat bg-center bg-[url(/assets/undanganDigital/website/frame-quote-min.png)]"
              ></div>
              <div className="grid items-center h-full px-6 overflow-y-auto">
                <p
                  ...
                  data-aos-duration="1000"
                  data-aos-delay="100"
                  className={`${playFair.className} leading-relaxed italic`}
                >
          ...
          <section className="container overflow-hidden pt-5 pb-12 grid mx-auto">
            <div className="p-6 text-center">
              <h1
                data-aos="zoom-in"
                data-aos-duration="1000"
                className={`${playFair.className} text-3xl text-secondary`}
              >
                The Wedding Of
              </h1>
              <p
                data-aos="fade-up"
                data-aos-duration="1000"
                className={`${playFair.className} my-2 italic`}
              >
            ...
            <div className="mt-5">
              ...
              <div>
                <div className="grid justify-center py-8">
                  <div
                    ...
                    data-aos-duration="1500"
                    data-aos-once="true"
                    className="relative w-56 h-56 rounded-full border-2 border-solid border-tertiaryInv"
                  >
                    <div
                      data-aos="zoom-in"
                      data-aos-duration="2000"
                      data-aos-delay="300"
                      data-aos-once="true"
                      className="bg-flower-pink absolute h-40 w-full bg-contain bg-no-repeat -z-10 -bottom-7 -left-10"
                    ></div>
                    <Image
                      src={
                        `https://sgp1.vultrobjects.com/virtuwed-storage/` +
                        wedding.undangan_digital.pengantin_pria.foto
                      }
                      alt="Mempelai Pria"
                ...
                <div className="text-center grid gap-y-2.5 px-2.5 py-5">
                  <h2
                    data-aos="fade-up"
                    data-aos-duration="1000"
                    className={`${playFair.className} uppercase text-4xl text-secondary`}
                  >
                    {wedding.undangan_digital.pengantin_pria.nama_lengkap}
                  </h2>
                  <p
                    data-aos="fade-up"
                    data-aos-duration="1000"
                    className={`${playFair.className} italic text-base`}
                  >
                    Putra dari Bapak{" "}
                    {wedding.undangan_digital.pengantin_pria.nama_ortu_bapak}{" "}
                    dan {wedding.undangan_digital.pengantin_pria.nama_ortu_ibu}
                  </p>
                  <div
                    data-aos="fade-up"
                    data-aos-duration="1000"
                  ...
                  >
                    ...
                    <a
                      className={`${playFair.className} italic text-base inline-block hover:underline underline-offset-4`}
                      href={`https://www.instagram.com/${wedding.undangan_digital.pengantin_pria.instagram}/`}
                      target="_blank"
                    >
                      @{wedding.undangan_digital.pengantin_pria.instagram}
                    </a>
                  </div>
                </div>
              </div>
              <div className="py-8">
                <h2
                  data-aos="fade-up"
                  data-aos-duration="1000"
                  className={`${playFair.className} text-center text-6xl text-tertiaryInv`}
                >
                  &
                </h2>
              </div>
              ...
              <div className="relative">
                <div
                  style={{ backgroundSize: "100% 100%" }}
                  className="absolute -z-10 bg-center bg-story-texture -bottom-64 left-0 right-0 mx-auto h-full w-[500px] bg-no-repeat"
                ></div>
                <div className="grid justify-center py-8">
                  <div
                    data-aos="zoom-in"
                  ...
                  >
                    ...
                    <Image
                      src={
                        `https://sgp1.vultrobjects.com/virtuwed-storage/` +
                        wedding.undangan_digital.pengantin_wanita.foto
                      }
                      alt="Mempelai Pria"
                ...
                <div className="text-center grid gap-y-2.5 px-2.5 py-5">
                  <h2
                    ...
                    className={`${playFair.className} uppercase text-4xl text-secondary`}
                  >
                    {wedding.undangan_digital.pengantin_wanita.nama_lengkap}
                  </h2>
                  <p
                    data-aos="fade-up"
                    data-aos-duration="1000"
                  ...
                  >
                    Putri dari{" "}
                    {wedding.undangan_digital.pengantin_wanita.nama_ortu_bapak}{" "}
                    dan Ibu{" "}
                  ...
                  >
                    ...
                    <a
                      ...
                      target="_blank"
                    >
                      @{wedding.undangan_digital.pengantin_wanita.instagram}
                    </a>
                  </div>
                </div>
              </div>
          ...
          <section className="relative overflow-hidden px-5">
            ...
            <div
              ...
              className="-z-10 absolute bottom-0 bg-silent-garden bg-no-repeat bg-center h-full w-[125%]"
            ></div>
            ...
            <div className="max-w-md mx-auto">
              <div className="grid gap-1 py-5">
                <h1
                  data-aos="fade-up"
                  data-aos-duration="1000"
                  className={`${playFair.className} text-tertiaryInv italic text-5xl leading-normal`}
                >
                  Save
                  <br />
                  The Date
                ...
                <p
                  ...
                  data-aos-duration="1000"
                  data-aos-delay="300"
                  className={`${playFair.className} text-secondary text-lg italic`}
                >
                  {wedding.reception_begin_at.date}
                </p>
              </div>
              ...
              <div
                ...
                data-aos-duration="1200"
                data-aos-delay="100"
                className="grid justify-center py-10"
              >
                {isClient && (
                  <Countdown
                    className={`${playFair.className} text-5xl text-secondary`}
                    date={`${yearPart}-${monthPart}-${dayPart}T${wedding.reception_begin_at.time}:00`}
                  />
                )}
              </div>
            ...
            <Tab.Group>
              <Tab.List className="h-12 flex px-4">
                <Tab
                  className={({ selected }) =>
                    classNames(
                      "flex justify-center items-center w-full px-4 border-b-2",
                      selected
              ...
              <Tab.Panels>
                ...
                <Tab.Panel className="grid w-full">
                  <div className="relative">
                    ...
                    <div
                      ...
                      className="-z-10 absolute bg-line-orn-event h-2.5 w-full bg-center bg-no-repeat -bottom-7"
                    ></div>
                    ...
                    <div className="grid gap-1.5 p-5 text-center">
                      <h2
                        data-aos="zoom-in"
                        data-aos-duration="1500"
                        className={`${playFair.className} text-2xl text-secondary italic`}
                      >
                        Intimate Reception
                      </h2>
                      <p
                        data-aos="fade-up"
                        data-aos-duration="1200"
                        className={`${playFair.className} text-base italic text-[#00000080]`}
                      >
                        Kami mengundang anda ke dalam Resepsi Pernikahan Virtual
                        (Virtual Wedding) berikut ini.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mt-20">
                    <div className="event-head text-center p-5 grid gap-5 relative">
                      ...
                      <div
                        ...
                        data-aos-delay="250"
                        style={{ backgroundSize: "auto 100%" }}
                        className="-z-10 absolute bg-forest h-[130%] w-full bg-center bg-no-repeat top-0 bottom-0 left-0 right-0 m-auto"
                      ></div>

                      <h3
                        data-aos="fade-up"
                        data-aos-duration="1000"
                        className={`${playFair.className} uppercase text-secondary text-xl tracking-[8px]`}
                      >
                      ...
                      <h2
                        data-aos="fade-up"
                        data-aos-duration="1000"
                        className={`${playFair.className} italic text-secondary text-3xl font-semibold`}
                      >
                        <span className="text-5xl">{dayPart}</span>{" "}
                        {wedding.reception_begin_at.month} {yearPart}
                      </h2>
                    </div>
                    ...
                    <div className="p-5 text-center">
                      ...
                      <h3
                        data-aos="fade-up"
                        data-aos-duration="1000"
                        className={`${playFair.className} mb-3 italic text-secondaryInvInv text-4xl text-tertiaryInv`}
                      >
                        Virtual Reception
                      </h3>
                      <p
                        data-aos="fade-up"
                        data-aos-duration="1000"
                        className={`${playFair.className} italic text-secondary text-lg`}
                      >
                    ...
                    <div className="grid p-5">
                      ...
                      >
                        <Link
                          href={`/${lang}/${wedding.wedding_slug}/${guest.guest_slug}/resepsivirtual`}
                          className={`${playFair.className} italic inline-block text-white border hover:bg-white border-solid hover:border-tertiaryInv rounded-lg pt-2 pb-2.5 px-6 hover:text-tertiaryInv bg-tertiaryInv transition-all ease-in-out`}
                        >
                          Hadiri Resepsi
                        </Link>
                      </div>
                ...
                <Tab.Panel className="grid w-full">
                  <div className="relative">
                    ...
                    <div className="grid gap-1.5 p-5 text-center">
                      ...
                      <p
                        ...
                        className={`${playFair.className} text-base italic text-[#00000080]`}
                      >
                        Kami mengundang anda ke Resepsi Pernikahan berikut ini.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mt-20">
                    ...
                    {wedding.undangan_digital.daftar_acara?.map(
                      (daftar_acara, key) => {
                        return (
                    ...
                    <div className="grid gap-2 p-5 text-center">
                      <p
                        data-aos="fade-up"
                        data-aos-duration="1000"
                        className={`${playFair.className} italic font-bold text-secondary`}
                      >
                        {wedding.undangan_digital.reception_location_name}
                      </p>
                      <p
                        data-aos="fade-up"
                        data-aos-duration="1000"
                        className={`${playFair.className} italic text-secondary`}
                      >
                        {wedding.undangan_digital.reception_location_address}
                      </p>
                      ...
                      >
                        <a
                          ...
                          target="_blank"
                          className={`${playFair.className} italic inline-block text-tertiaryInv border bg-white border-solid border-tertiaryInv rounded-lg pt-2 pb-2.5 px-6 hover:text-white hover:bg-tertiaryInv transition-all ease-in-out`}
                        >
                          View Maps
                        </a>
                      </div>
            ...
            <div className="max-w-md mx-auto">
              <div className="px-5 py-6">
                <h1
                  data-aos="fade-up"
                  data-aos-duration="1000"
                  className={`${playFair.className} text-secondary italic text-left text-4xl`}
                >
                  Our Moment
                </h1>
              </div>
          ...
          <section className="min-w-full pt-5 pb-10 bg-gradient-to-b from-white from-70% to-secondary to-90%">
            <h1
              data-aos="fade-right"
              data-aos-duration="1000"
              className={`${playFair.className} text-secondary italic text-left text-4xl p-5`}
            >
              Our Story
            </h1>
            ...
            <div className={`${playFair.className}`}>
              <Chrono
                items={wedding.undangan_digital.kisah_cinta.map(
                  (loveStory) => ({
                    title: `${loveStory.kisah_cinta_date.split("-")[2]}-${
                      loveStory.kisah_cinta_date.split("-")[1]
                    }-${loveStory.kisah_cinta_date.split("-")[0]}`,
          ...
          <section className="bg-secondary pt-5 pb-2.5">
            <div className="p-5 grid gap-4">
              <h1
                data-aos="fade-up"
                data-aos-duration="1000"
                className={`${playFair.className} text-white italic text-left text-4xl`}
              >
                Wedding Wish
              </h1>
              <p
                ...
                data-aos-duration="1000"
                data-aos-delay="300"
                className={`${playFair.className} text-white italic text-left text-base`}
              >
                {ucapanUndanganDigital?.total} Comments
              </p>
              ...
              <div className="flex justify-between">
                ...
                <div className="border-2 rounded border-solid border-white p-4 grid items-center justify-items-center w-20">
                  <h2 className={`${playFair.className} text-3xl text-white`}>
                    {ucapanUndanganDigital?.hadir}
                  </h2>
                  <p
                    className={`${playFair.className} text-base text-white text-center italic`}
                  >
                    Hadir
                  </p>
                </div>
            ...
            <form className="p-5" onSubmit={handleFormSubmit}>
              ...
              <div className="mb-4">
                <textarea
                  ...
                  data-aos="fade-up"
                  data-aos-duration="1200"
                  className={`${playFair.className} italic shadow appearance-none rounded w-full min-h-[100px] p-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline`}
                ...
                >
                  <div className="relative mt-1">
                    <Listbox.Button className="z-50 relative w-full cursor-default rounded bg-white py-2 pl-3 pr-10 text-left focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm">
                      <span
                        className={`${playFair.className} italic block truncate`}
                      >
              ...
              <div className="flex items-center justify-between z-10">
                <button
                  ...
                  data-aos="fade-up"
                  data-aos-duration="1200"
                  className={`${playFair.className} bg-tertiaryInv text-white hover:text-tertiaryInv border hover:bg-white border-tertiaryInv transition-all ease-in-out italic py-2 px-8 rounded `}
                  type="submit"
                >
                  Kirim
                </button>
            ...
            <div className="p-5">
              ...
              {ucapanUndanganDigital?.data?.map((data, key) => (
                ...
                >
                  <div>
                    <h3
                      className={`${playFair.className} text-lg text-white font-bold`}
                    >
                      {data.nama}
                    </h3>
                    <small
                      className={`${playFair.className} text-xs text-white italic`}
                    >
                  ...
                  <div className="mt-2.5">
                    <p
                      className={`${playFair.className} text-base text-white italic`}
                    >
            ...
            <div className="p-5">
              {ucapanUndanganDigital?.data &&
                displayCount < ucapanUndanganDigital?.data?.length && (
                  <button
                    className={`${playFair.className} bg-tertiaryInv text-white w-full py-2.5 px-5 rounded text-base italic border hover:bg-white border-tertiaryInv transition-all ease-in-out`}
          ...
          <section className="bg-secondary container min-w-full grid justify-center relative py-7 overflow-hidden mx-auto">
            ...
            <div className="left-0 right-0 mx-auto">
              <div
                className="absolute min-w-full h-full w-[240%] max-w-[900px] bg-no-repeat bg-center bg-forest-landscape opacity-20"
                style={{
                  backgroundSize: "100% auto",
                  top: "50%",
                  left: "50%",
            ...
            <div className="relative px-5 py-16 mt-36 text-center grid gap-5">
              ...
              <div
                ...
                data-aos-duration="1500"
                data-aos-delay="200"
                className="z-10 absolute left-0 right-0 mx-auto h-full w-[130px] rounded-full bg-secondary/70"
              />
              <p
                data-aos-once="true"
                data-aos="fade-up"
                data-aos-duration="1200"
                className={`${playFair.className} italic z-20 text-white text-base`}
              >
                Two souls become one heart
              </p>
              <h1
                ...
                data-aos-duration="1500"
                data-aos-delay="200"
                className={`${playFair.className} z-20 text-6xl text-white`}
              >
                {wedding.wedding_name.replace("&", "")}
              </h1>
              ...
              <p
                ...
                data-aos-duration="1200"
                data-aos-delay="500"
                className={`${playFair.className} z-20 text-xl text-white`}
              >
                {wedding.reception_begin_at.date}
              </p>
            </div>
          ...
          <footer className="bg-secondary py-2.5 grid justify-center min-w-full">
            <div>
              <p
                className={`${playFair.className} italic text-center text-white`}
              >
                Powered by{" "}
                <Link
                  href="/"
                  className={`font-ade uppercase hover:underline not-italic`}
                >
                  virtuwed
                </Link>
              </p>
