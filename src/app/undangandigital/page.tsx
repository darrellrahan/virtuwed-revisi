...
const page = () => {
    return (
        <>
            <main className='container min-h-screen mx-auto lg:grid lg:grid-cols-12 lg:relative'>
                <section className='hidden lg:grid col-span-8 h-screen w-4/6 bg-primary fixed p-5'>
                    <div className='w-full h-full grid items-end bg-no-repeat bg-cover-wedding bg-cover bg-center p-20'>
                        <h1 className='text-white text-7xl'>NATKUN & FUTABA</h1>
                    </div>
                </section>
